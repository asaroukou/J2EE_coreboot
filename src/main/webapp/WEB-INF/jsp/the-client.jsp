                    ...
                    <ul class="list-group">
                        <c:forEach var = "i" items="${client.getSessions()}">
                            <li class="list-group-item"><span>
                             ...
                             <a href="/the-client/${client.getId()}/sessions/${i.getId()}/remove" style="color: rgb(255,0,0);float: right;">Se désinscire</a></li>
                        </c:forEach>
                    </ul>
                </div>
                <div class="col">
                    <ul class="list-group">
                        <c:forEach var = "i" items="${sessionss}">
                            <li class="list-group-item"><span>
                                    ${i.getCourse().getCode()} - ${i.getLocation().getCity()}
                                    - <fmt:formatDate pattern = "dd-MM-yyyy" value = "${i.getStartDate() }" />
                                        >
                                ...
                                <a href="/the-client/${client.getId()}/sessions/${i.getId()}/add" style="float: right;">S'inscire</a></li>
                        </c:forEach>
                    </ul>
                </div>
            </div>
