    ...
    <section class="clean-block features">
        <div class="container">
            <div class="block-heading">
                <h2 class="text-info">Liste des client</h2>
            </div>
            <div class="row justify-content-center">
                <div class="table-responsive">
                    <table class="table table-striped">
                        <thead>
                        <tr>
                            <th style="width: 265px;">Nom &amp;&nbsp;<strong>Prénom</strong></th>
                            <th>Adresse</th>
                            <th>Téléphone</th>
                            <th>E-mail</th>
                        ...
                        <tbody>
                            <c:forEach var = "i" items="${clients}">
                                <tr>
                                    ...
                                    <td>${i.getPhone() }</td>
                                    <td>${i.getEmail() }</td>
                                    <td><a href="#">Consulter</a><span>&nbsp;|&nbsp;</span><a href="#">Modifier</a><span>&nbsp;|&nbsp;</span><a href="#">Supprimer</a></td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
