    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form action="/add-course" method="POST">
                <div class="form-group"><label>Code</label><input class="form-control" type="text" name="code" required>
                </div>
                <div class="form-group"><label>Titre</label><input class="form-control" type="text" name="title"
                                                                   required></div>
                <div class="form-group">
                    <button class="btn btn-primary btn-block" type="submit">Créer cours</button>
                </div>
            </form>
        </div>
    </section>
