...
<head>
    ...
    <title>Ajouter site formation</title>
    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form action="/add-site" method="POST">
                <div class="form-group"><label>Ville</label><input class="form-control" type="text" name="city"
                                                                   required></div>
                <div class="form-group">
                    <button class="btn btn-primary btn-block" type="submit">Créer site</button>
                </div>
            </form>
        </div>
    </section>
